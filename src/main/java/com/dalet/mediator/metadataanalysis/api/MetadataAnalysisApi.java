...
public class MetadataAnalysisApi {
    ...
    /**
     * Build call for segmentText
     * @param projectServiceId Project service id of the client associated to the request (required)
     * @param segmentTextRequest Request which contains the needed information for the segment operation. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call segmentTextCall(String projectServiceId, SegmentTextRequest segmentTextRequest, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = segmentTextRequest;

        // create path and map variables
        String localVarPath = "/metadata-analysis/segment-text";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call segmentTextValidateBeforeCall(String projectServiceId, SegmentTextRequest segmentTextRequest, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'projectServiceId' is set
        if (projectServiceId == null) {
            throw new ApiException("Missing the required parameter 'projectServiceId' when calling segmentText(Async)");
        }
        
        // verify the required parameter 'segmentTextRequest' is set
        if (segmentTextRequest == null) {
            throw new ApiException("Missing the required parameter 'segmentTextRequest' when calling segmentText(Async)");
        }
        

        okhttp3.Call localVarCall = segmentTextCall(projectServiceId, segmentTextRequest, _callback);
        return localVarCall;
     ...
     */
    public SegmentTextResponse segmentText(String projectServiceId, SegmentTextRequest segmentTextRequest) throws ApiException {
        ApiResponse<SegmentTextResponse> localVarResp = segmentTextWithHttpInfo(projectServiceId, segmentTextRequest);
        return localVarResp.getData();
    }
     ...
     * @param projectServiceId Project service id of the client associated to the request (required)
     * @param segmentTextRequest Request which contains the needed information for the segment operation. (required)
     * @return ApiResponse&lt;SegmentTextResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<SegmentTextResponse> segmentTextWithHttpInfo(String projectServiceId, SegmentTextRequest segmentTextRequest) throws ApiException {
        okhttp3.Call localVarCall = segmentTextValidateBeforeCall(projectServiceId, segmentTextRequest, null);
        Type localVarReturnType = new TypeToken<SegmentTextResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call segmentTextAsync(String projectServiceId, SegmentTextRequest segmentTextRequest, final ApiCallback<SegmentTextResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = segmentTextValidateBeforeCall(projectServiceId, segmentTextRequest, _callback);
        Type localVarReturnType = new TypeToken<SegmentTextResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for translateCaptions
     * @param projectServiceId Project service id of the client associated to the request (required)
     * @param translateCaptionsRequest Request which contains the needed information for the traslate captions operation. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call translateCaptionsCall(String projectServiceId, TranslateCaptionsRequest translateCaptionsRequest, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = translateCaptionsRequest;

        // create path and map variables
        String localVarPath = "/metadata-analysis/translate-captions";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call translateCaptionsValidateBeforeCall(String projectServiceId, TranslateCaptionsRequest translateCaptionsRequest, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'projectServiceId' is set
        if (projectServiceId == null) {
            throw new ApiException("Missing the required parameter 'projectServiceId' when calling translateCaptions(Async)");
        }
        
        // verify the required parameter 'translateCaptionsRequest' is set
        if (translateCaptionsRequest == null) {
            throw new ApiException("Missing the required parameter 'translateCaptionsRequest' when calling translateCaptions(Async)");
        }
        

        okhttp3.Call localVarCall = translateCaptionsCall(projectServiceId, translateCaptionsRequest, _callback);
        return localVarCall;
     ...
     */
    public TranslateCaptionsResponse translateCaptions(String projectServiceId, TranslateCaptionsRequest translateCaptionsRequest) throws ApiException {
        ApiResponse<TranslateCaptionsResponse> localVarResp = translateCaptionsWithHttpInfo(projectServiceId, translateCaptionsRequest);
        return localVarResp.getData();
    }
     ...
     * @param projectServiceId Project service id of the client associated to the request (required)
     * @param translateCaptionsRequest Request which contains the needed information for the traslate captions operation. (required)
     * @return ApiResponse&lt;TranslateCaptionsResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<TranslateCaptionsResponse> translateCaptionsWithHttpInfo(String projectServiceId, TranslateCaptionsRequest translateCaptionsRequest) throws ApiException {
        okhttp3.Call localVarCall = translateCaptionsValidateBeforeCall(projectServiceId, translateCaptionsRequest, null);
        Type localVarReturnType = new TypeToken<TranslateCaptionsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call translateCaptionsAsync(String projectServiceId, TranslateCaptionsRequest translateCaptionsRequest, final ApiCallback<TranslateCaptionsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = translateCaptionsValidateBeforeCall(projectServiceId, translateCaptionsRequest, _callback);
        Type localVarReturnType = new TypeToken<TranslateCaptionsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
